...
{
    public partial class FormMale : Form
    {
        ...
        private void ShowMaleProduct()
        {
            OracleCommand cmd = new OracleCommand("ShowMaleProduct", conn);
        ...
        private void FormMale_Load(object sender, EventArgs e)
        {
            ShowMaleProduct();
            dataGridView1.ClearSelection();
        ...
        {
            OracleCommand cmd = new OracleCommand("SearchMaleProduct", conn);
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.Add("product", txtSearch.Text.Trim());
            OracleDataAdapter adapter = new OracleDataAdapter(cmd);
            DataSet ds = new DataSet();
        ...
        private void DataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            txtQty.Visible = false;
            a = 0;
            img.Image = Properties.Resources.dior_shop_new_york;
            dataGridView1.ClearSelection();
            btnClear.Visible = false;
            lblPrice.Text = "";
            try
        ...
        private void BtnClear_Click(object sender, EventArgs e)
        {
            ...
            txtQty.Visible = false;
            a = 0;
            img.Image = Properties.Resources._7;
            dataGridView1.ClearSelection();
            btnClear.Visible = false;
            txtTotalPrice.Visible = false;
            lblTotal.Visible = false;
