...
namespace ClothesManagementSystem
{
    public partial class FormChildren : Form
    {
		...
		{
			OracleCommand cmd = new OracleCommand("CHILD", conn);
		...
		private void FormChildren_Load_1(object sender, EventArgs e)
		{
			showchild();
			dataGridView1.ClearSelection();
		...
		private void btnShoppingBasket_Click_1(object sender, EventArgs e)
		{
		...
		{
			OracleCommand cmd = new OracleCommand("searchchild", conn);
			cmd.CommandType = CommandType.StoredProcedure;
